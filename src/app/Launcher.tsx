...
export function Launcher({ onOpen }: { onOpen: (id: ToolId) => void }) {
  return (
    <div className="mx-auto max-w-[900px] px-8 pt-12 pb-12">
      <div className="mb-8">
        <h1 className="text-[22px] font-semibold tracking-[-.015em] text-foreground">
          Toolbox
        </h1>
        <p className="mt-1 text-[13.5px] text-muted-foreground">
          Local utilities for daily workflows. Nothing leaves your machine.
        </p>
      </div>
